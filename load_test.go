...
func TestLoadFileFailssWithMissingFile(t *testing.T) {
	...
	// Error should be nil
	assert.EqualError(t, err, "Error processing file bad_filename.yml: open bad_filename.yml: no such file or directory")
}
...
func TestLoadFilesFailsWithABadFile(t *testing.T) {
	...
	// Error should be nil
	assert.EqualError(t, err, "Error processing file bad_file: open bad_file: no such file or directory")
